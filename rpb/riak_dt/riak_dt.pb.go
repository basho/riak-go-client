...
type MapEntry struct {
	...
	CounterValue     *int64      `protobuf:"zigzag64,2,opt,name=counter_value,json=counterValue" json:"counter_value,omitempty"`
	SetValue         [][]byte    `protobuf:"bytes,3,rep,name=set_value,json=setValue" json:"set_value,omitempty"`
	RegisterValue    []byte      `protobuf:"bytes,4,opt,name=register_value,json=registerValue" json:"register_value,omitempty"`
	FlagValue        *bool       `protobuf:"varint,5,opt,name=flag_value,json=flagValue" json:"flag_value,omitempty"`
	MapValue         []*MapEntry `protobuf:"bytes,6,rep,name=map_value,json=mapValue" json:"map_value,omitempty"`
	XXX_unrecognized []byte      `json:"-"`
}
...
type DtFetchReq struct {
	...
	BasicQuorum  *bool   `protobuf:"varint,6,opt,name=basic_quorum,json=basicQuorum" json:"basic_quorum,omitempty"`
	NotfoundOk   *bool   `protobuf:"varint,7,opt,name=notfound_ok,json=notfoundOk" json:"notfound_ok,omitempty"`
	Timeout      *uint32 `protobuf:"varint,8,opt,name=timeout" json:"timeout,omitempty"`
	SloppyQuorum *bool   `protobuf:"varint,9,opt,name=sloppy_quorum,json=sloppyQuorum" json:"sloppy_quorum,omitempty"`
	NVal         *uint32 `protobuf:"varint,10,opt,name=n_val,json=nVal" json:"n_val,omitempty"`
	// For read-only requests or context-free operations, you can set
	// this to false to reduce the size of the response payload.
	IncludeContext   *bool  `protobuf:"varint,11,opt,name=include_context,json=includeContext,def=1" json:"include_context,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type DtValue struct {
	CounterValue *int64      `protobuf:"zigzag64,1,opt,name=counter_value,json=counterValue" json:"counter_value,omitempty"`
	SetValue     [][]byte    `protobuf:"bytes,2,rep,name=set_value,json=setValue" json:"set_value,omitempty"`
	MapValue     []*MapEntry `protobuf:"bytes,3,rep,name=map_value,json=mapValue" json:"map_value,omitempty"`
	// We return an estimated cardinality of the Hyperloglog set
	// on fetch.
	HllValue         *uint64  `protobuf:"varint,4,opt,name=hll_value,json=hllValue" json:"hll_value,omitempty"`
	GsetValue        [][]byte `protobuf:"bytes,5,rep,name=gset_value,json=gsetValue" json:"gset_value,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
type MapUpdate struct {
	Field     *MapField  `protobuf:"bytes,1,req,name=field" json:"field,omitempty"`
	CounterOp *CounterOp `protobuf:"bytes,2,opt,name=counter_op,json=counterOp" json:"counter_op,omitempty"`
	SetOp     *SetOp     `protobuf:"bytes,3,opt,name=set_op,json=setOp" json:"set_op,omitempty"`
	//
	// There is only one operation on a register, which is to set its
	// value, therefore the "operation" is the new value.
	RegisterOp       []byte            `protobuf:"bytes,4,opt,name=register_op,json=registerOp" json:"register_op,omitempty"`
	FlagOp           *MapUpdate_FlagOp `protobuf:"varint,5,opt,name=flag_op,json=flagOp,enum=MapUpdate_FlagOp" json:"flag_op,omitempty"`
	MapOp            *MapOp            `protobuf:"bytes,6,opt,name=map_op,json=mapOp" json:"map_op,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}
...
type DtOp struct {
	CounterOp *CounterOp `protobuf:"bytes,1,opt,name=counter_op,json=counterOp" json:"counter_op,omitempty"`
	SetOp     *SetOp     `protobuf:"bytes,2,opt,name=set_op,json=setOp" json:"set_op,omitempty"`
	MapOp     *MapOp     `protobuf:"bytes,3,opt,name=map_op,json=mapOp" json:"map_op,omitempty"`
	// Adding values to a hyperloglog (set) is just like adding values
	// to a set.
	HllOp            *HllOp  `protobuf:"bytes,4,opt,name=hll_op,json=hllOp" json:"hll_op,omitempty"`
	GsetOp           *GSetOp `protobuf:"bytes,5,opt,name=gset_op,json=gsetOp" json:"gset_op,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type DtUpdateReq struct {
	...
	ReturnBody       *bool   `protobuf:"varint,9,opt,name=return_body,json=returnBody,def=0" json:"return_body,omitempty"`
	...
	IncludeContext   *bool   `protobuf:"varint,13,opt,name=include_context,json=includeContext,def=1" json:"include_context,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
type DtUpdateResp struct {
	...
	CounterValue     *int64      `protobuf:"zigzag64,3,opt,name=counter_value,json=counterValue" json:"counter_value,omitempty"`
	SetValue         [][]byte    `protobuf:"bytes,4,rep,name=set_value,json=setValue" json:"set_value,omitempty"`
	MapValue         []*MapEntry `protobuf:"bytes,5,rep,name=map_value,json=mapValue" json:"map_value,omitempty"`
	HllValue         *uint64     `protobuf:"varint,6,opt,name=hll_value,json=hllValue" json:"hll_value,omitempty"`
	GsetValue        [][]byte    `protobuf:"bytes,7,rep,name=gset_value,json=gsetValue" json:"gset_value,omitempty"`
	XXX_unrecognized []byte      `json:"-"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
