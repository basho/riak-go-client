...
// GetStringValue returns the data type of the value stored within the cell
func (c *TsCell) GetStringValue() string {
	return string(c.cell.GetVarcharValue())
}

// GetBooleanValue returns the data type of the value stored within the cell
func (c *TsCell) GetBooleanValue() bool {
	return c.cell.GetBooleanValue()
}

// GetDoubleValue returns the data type of the value stored within the cell
func (c *TsCell) GetDoubleValue() float64 {
	return c.cell.GetDoubleValue()
}

// GetSint64Value returns the data type of the value stored within the cell
func (c *TsCell) GetSint64Value() int64 {
	return c.cell.GetSint64Value()
}

// GetTimestampValue returns the data type of the value stored within the cell
...
// TsStoreRowsCommand is sused to store a new search index on Riak
...
// WithTable sets the bucket to be used by the command
...
// TsDeleteRowCommand is used to fetch / get a value from Riak KV
type TsDeleteRowCommand struct {
	commandImpl
	timeoutImpl
	retryableCommandImpl
	Response *TsDeleteRowResponse
...
func (cmd *TsDeleteRowCommand) onSuccess(msg proto.Message) error {
	...
	if msg == nil {
		cmd.Response = &TsDeleteRowResponse{
			IsNotFound: true,
		}
	}
	return nil
...
// TsDeleteRowResponse contains the response data for a TsDeleteRowCommand
type TsDeleteRowResponse struct {
	IsNotFound bool
}
...
// TsQueryCommand is used to fetch / get a value from Riak KV
...
// WithTsQuery sets the bucket to be used by the command
func (builder *TsQueryCommandBuilder) WithTsQuery(Tsquery string) *TsQueryCommandBuilder {
	builder.protobuf.Query = &riak_ts.TsInterpolation{Base: []byte(Tsquery)}
	return builder
}
...
// TsListKeysCommand is used to fetch / get a value from Riak KV
